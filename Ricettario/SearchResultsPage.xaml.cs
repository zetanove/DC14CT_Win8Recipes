...
namespace Ricettario
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            // Search recipes and tabulate results (added byJDP)
            ...
            foreach (var group in groups)
            {
                ...
                var matches = group.Items.Where(x =>
                    x.Title.IndexOf(queryText, StringComparison.OrdinalIgnoreCase) >= 0 ||
                    x.Directions.IndexOf(queryText, StringComparison.OrdinalIgnoreCase) >= 0).ToArray();
        ...
        private void OnItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(ItemPage), ((RecipeDataItem)e.ClickedItem).UniqueId);
        }
    }
}
